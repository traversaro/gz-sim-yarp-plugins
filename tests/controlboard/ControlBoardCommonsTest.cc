...
TEST_P(ControlBoardInitialConfigurationTest, CheckInitialConfiguration) {
    ...
    for (int i = 0; i < params.expectedJointInitialPosInRad.size(); i++) {
        ...
        EXPECT_DOUBLE_EQ(initialPosInDeg, gzyarp::convertRadiansToDegrees(params.expectedJointInitialPosInRad[i]));
    }
}
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        // Temporary disabled
        // ControlBoardInitialConfigurationTestsParams{"pendulum_with_doubly_overriden_initial_configuration.sdf", {2.0}}
